...
class OpenAIAdapter:
    ...
    async def generate_report(self, course_name: str, group_id: str = None):
        system = "Produce a short analytical summary for administration. Respond JSON: {summary:str, excel_path:null}."
        ...
        try:
            ...
            return {"summary": f"Guruh: {group_id or 'Barcha'} — {course_name}: O'rtacha 78%.", "excel_path": None}
